            ...
            >
              ...
              <div className="relative h-52 overflow-hidden">
                ...
                <div className="absolute top-4 left-4">
                  <span className="px-3 py-1 bg-white/95 backdrop-blur-sm rounded-full text-[10px] font-black uppercase tracking-widest text-sdy-black shadow-sm">
                    {t(program.pillar)}
                  </span>
                </div>
              </div>
              ...
              <div className="p-7 flex-grow flex flex-col">
                <h3 className="text-xl font-black mb-3 group-hover:text-sdy-red transition-colors duration-200 leading-snug">
                  {t(program.title)}
                </h3>
                ...
                <div className="space-y-2 mb-6">
                  <div className="flex items-center gap-2.5 text-[12px] font-bold text-gray-400">

...
**Version:** 1.1 | **Last Updated:** April 2026 | **Owner:** SDY Digital Team
...
2. Scans program cards or uses filter
3. Clicks on a program of interest
4. Reads program detail: dates, format, eligibility, outcomes
5. Clicks "Apply" or "Register"
6. Completes short application form
7. Receives confirmation and calendar invite

**UX Considerations:**
- Program cards show critical info (date, pillar, format) without clicking through
- Application form must be distinct from membership form
- If program is full, show waitlist option — never dead end the user
- Clearly show whether the program is free or paid
...
### CMS / Admin Structure
- Content editors can publish articles and update program info without developer help
- Developer access required for: homepage structure changes, new page templates, plugin updates
- Role-based access: Admin, Editor, Author
- Automatic daily backups retained for 30 days
- Staging environment available for testing before production deploys
...
- Program applications: views → submissions
...
**Member Portal**
- Login for registered SDY members
...
- Chatbot for answering "What is SDY?", "How do I join?", "What programs are available?"
- Reduces load on contact team for repetitive inquiries

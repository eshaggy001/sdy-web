...
export const LEADERS: Leader[] = [
  {
    ...
    role: { mn: 'SDY-ны Ерөнхийлөгч', en: 'SDY President' },
    image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=400',
    bio: {
      mn: '2024 оноос хойш SDY-г удирдаж байгаа бөгөөд дижитал шилжилт, бүс нутгийн өсөлтөд анхаарлаа хандуулж байна.',
